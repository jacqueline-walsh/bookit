...
class TestOrderModel(TestCase):
  ...
  def test_billing_address(self):
      billing_address = Order(billingName='Test Billing Name', billingAddress1='Test Address1', billingCity="Test City", billingPostcode="Test Postcode", billingCountry="Test Country")
  ...
  def test_shipping_address(self):
      shipping_address = Order(shippingName='Test Billing Name', shippingAddress1='Test Address1', shippingCity="Test City", shippingPostcode="Test Postcode", shippingCountry="Test Country")
...
class TestOrderItemModel(TestCase):
  ...
  def test_order_exists(self):
      ...
      order_id.save()
      order_item = OrderItem(book="Test book title", quantity=2, price=9.99, order=order_id)
      order_item.save()
